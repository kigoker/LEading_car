...
clean-code:
	-$(RM) ./code/Control.d ./code/Control.o ./code/Control.src ./code/Encoder.d ./code/Encoder.o ./code/Encoder.src ./code/Flash.d ./code/Flash.o ./code/Flash.src ./code/Init_car.d ./code/Init_car.o ./code/Init_car.src ./code/KEY.d ./code/KEY.o ./code/KEY.src ./code/Motor.d ./code/Motor.o ./code/Motor.src ./code/PID.d ./code/PID.o ./code/PID.src ./code/UI.d ./code/UI.o ./code/UI.src ./code/Wireless_transmission.d ./code/Wireless_transmission.o ./code/Wireless_transmission.src ./code/camera.d ./code/camera.o ./code/camera.src ./code/image_dealwith.d ./code/image_dealwith.o ./code/image_dealwith.src ./code/imu.d ./code/imu.o ./code/imu.src
